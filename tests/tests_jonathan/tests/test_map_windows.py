...
def left_bases(
    ...
    left_bases: Series[int64] = Series[int64](
        peak_map[str(mp._pb_l_col)], dtype=int64
    )
    return left_bases
...
def right_bases(
    ...
    right_bases: Series[int64] = Series[int64](
        peak_map[mp._pb_r_col], dtype=int64
    )
    return right_bases
...
class Test_Peak_W_Intvl_Factory:
    ...
    def test_peak_base_intvl_factory(
        self,
        pb_intvls: Series[pd.Interval],) -> None:
    ...
    def test_p_wdw_intvl_factory(
        ...
        peak_wdw_intvls_1 = mw._p_wdw_intvl_factory(left_bases=left_bases, right_bases=right_bases)
...
def pb_intvls(
    ...
    """
    pb_intvls: Series[pd.Interval] = mw._peak_base_intvl_factory(left_bases, right_bases)
    return pb_intvls
...
def peak_wdw_intvls(
    ...
    """
    w_intvls: dict[int, pd.Interval] = mw._set_wdw_intvls_from_peak_intvls(pb_intvls, wdw_peak_mapping)
    return w_intvls
...
def X_idx_pw(
    ...
    X_idx_w: DataFrame[PeakWindows] = mw._peak_intvls_as_frame(peak_wdw_intvls=peak_wdw_intvls)
