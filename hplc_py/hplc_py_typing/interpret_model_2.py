...
class InterpetModel:
    ...
    def gen_schema_def(
        ...
        signature = self._gen_class_signature(
            class_name=sch_name, inherit_from=inherit_from
        )
...
class Field:
    ...
    def __init__(self, series: pd.Series, check: str):
        ...
        self.dtype_replacements = {
            "numpy.dtypes.Int64DType": "np.int",
            "numpy.dtypes.ObjectDType": "object_",
            "category": "CategoricalDtype",
            "string": "StringDtype",
        }

    def gen_field(self) -> Self:
    ...
    def get_builtin_checkstrs(self, series: pd.Series):
        """
